...
<div class="row">
    <div class="col-md-12">
        <form action="{{ route('faq.imported') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="border p-2">
                ...
                <p>Impor data faq dari berkas Excel. Silahkan <a href="{{ url('/app-admin/faq/format-excel-import') }}">download panduan format file excel</a>.</p>
