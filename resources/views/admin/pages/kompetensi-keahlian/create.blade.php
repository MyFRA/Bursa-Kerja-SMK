    ...
    <div class="col-md-4">
        <form action="{{ route('kompetensi-keahlian.store') }}" method="post" class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="nama">{{__('KOMPETENSI KEAHLIAN')}} <span class="text-danger">*</span></label>
    ...
    <div class="col-md-8">
        <div class="border p-3">
            <h6 class="text-uppercase border-bottom font-weight-bold font-size-sm pb-2">
                <i class="fas fa-info-circle mr-2"></i>{{__('DETAIL KOMPETENSI KEAHLIAN')}}
            </h6>
