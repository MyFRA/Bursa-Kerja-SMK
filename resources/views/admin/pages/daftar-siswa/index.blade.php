                ...
                @foreach($items as $val)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="#" onclick="onDestroy('<?= url('/app-admin/daftar-siswa/' . encrypt($val->id)) ?>', '{{ $val->nama_pertama }}')" class="mx-1 text-danger">
...
<script>
    ...
    function onHapusMassal(url) {
        ...
        Swal.fire({
            title: 'KONFIRMASI',
            text: 'Apakah anda yakin akan menghapus massal ?, semua Siswa akan terhapus secara permanen !',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
