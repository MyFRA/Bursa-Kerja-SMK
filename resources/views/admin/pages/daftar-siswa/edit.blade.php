        ...
        <form action="{{ url('/app-admin/daftar-siswa/' . encrypt($item->id)) }}" method="post" class="card" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input id="image" type="file" name="photo" value="{{ old('photo') ? old('photo') : $item->photo }}" class="form-control @error('photo') is-invalid @enderror" / >
                ...
                <div class="form-group">
                    <label for="kartu_identitas">Kartu Identitas<span class="text-danger">*</span></label>
                    
                    <select name="kartu_identitas" id="kartu_identitas">
                        <option value="KTP" {{ ($item->kartu_identitas == "KTP") ? 'selected' : '' }}>KTP</option>
                        <option value="SIM" {{ ($item->kartu_identitas == "SIM") ? 'selected' : '' }}>SIM</option>
                        <option value="NPWP" {{ ($item->kartu_identitas == "NPWP") ? 'selected' : '' }}>NPWP</option>
                        <option value="KARTU PELAJAR" {{ ($item->kartu_identitas == "KARTU PELAJAR") ? 'selected' : '' }}>KARTU PELAJAR</option>
                    </select>
    ...
    <div class="col-md-8">
        ...
        <div class="card collapsed-card">
            ...
            <div class="card-body p-2">
                <div class="form-group">
                    <img class="img-fluid img-thumbnail" src="{{ asset('/storage/assets/daftar-siswa') }}/{{ $item->photo }}" alt="">
                  </div>
            </div>
        </div>
        <div class="card collapsed-card">
