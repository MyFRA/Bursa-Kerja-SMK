...
<div class="row">
    <div class="col-md-4">
        <form action="{{ url('/app-admin/program-keahlian/' . encrypt($item->id)) }}" method="post" class="card">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="nama">NAMA PROGRAM KEAHLIAN <span class="text-danger">*</span></label>
    ...
    <div class="col-md-8">
        <div class="border p-3">
            <h6 class="text-uppercase border-bottom font-weight-bold font-size-sm pb-2">
                <i class="fas fa-info-circle mr-2"></i>DETAIL PROGRAM KEAHLIAN
            </h6>
            <table class="table table-striped table-sm">
                ...
                <tr>
                    <td width="30%">NAMA PROGRAM KEAHLIAN</td>
                    <td width="5px">:</td>
                    <td>{{ $item->nama }}</td>
                </tr>
                <tr>
